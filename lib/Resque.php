...
class Resque
{
    ...
    /**
     * @var Client Instance of Predis\Client that talks to redis.
     */
    ...
    /**
     * @var array Options for Predis client for replication or other features
     */
     ...
     * @param int $database
     */
    public static function setBackend($server, $options = [], $database = 0)
    {
     ...
     *
     * @return Client Instance of Resque_Redis.
     */
